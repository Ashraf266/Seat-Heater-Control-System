...
const Port_ConfigType Port_Configuration = {
	   {{ PORT_PIN_A0_ID , PORT_PIN_MODE_DIO, PORT_PIN_MODE_NOT_CHANGEABLE, PORT_PIN_IN, PORT_PIN_DIRECTION_NOT_CHANGEABLE, PORT_PIN_INTERNAL_RES_OFF, PORT_PIN_LEVEL_LOW},
		{ PORT_PIN_A1_ID , PORT_PIN_MODE_DIO, PORT_PIN_MODE_NOT_CHANGEABLE, PORT_PIN_IN, PORT_PIN_DIRECTION_NOT_CHANGEABLE, PORT_PIN_INTERNAL_RES_OFF, PORT_PIN_LEVEL_LOW},
		...
		{ PORT_PIN_A7_ID , PORT_PIN_MODE_DIO, PORT_PIN_MODE_NOT_CHANGEABLE, PORT_PIN_IN, PORT_PIN_DIRECTION_NOT_CHANGEABLE, PORT_PIN_INTERNAL_RES_OFF, PORT_PIN_LEVEL_LOW},
